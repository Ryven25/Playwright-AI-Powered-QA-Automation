...
test.describe('DS-4: Delete Program - Positive Flows', () => {
  ...
  test('TC-01: Delete icon opens a confirmation dialog', async ({ page }) => {
    const programs = new ProgramsPage(page);
  ...
  test('TC-02: Confirming deletion removes the program from the list', async ({ page }) => {
    const programs = new ProgramsPage(page);
    const name = unique('Test Program');
    await createProgramAndTrack(programs, name);
...
test.describe('DS-4: Delete Program - Negative Flows', () => {
  ...
  test('TC-04: Dismissing confirmation does not delete the program', async ({ page }) => {
    const programs = new ProgramsPage(page);
  ...
  test('TC-05: Deleting one program does not affect other programs', async ({ page }) => {
    const programs = new ProgramsPage(page);
...
test.describe('DS-4: Delete Program - Edge Cases', () => {
  ...
  test('TC-06: Delete a program whose name contains special characters', async ({ page }) => {
    const programs = new ProgramsPage(page);
  ...
  test('TC-07: Confirmation dialog message includes the program name', async ({ page }) => {
    const programs = new ProgramsPage(page);
    const name = unique('Test Program');
    await createProgramAndTrack(programs, name);
  ...
  test('TC-08: Confirmation dialog warns that deletion cannot be undone', async ({ page }) => {
    const programs = new ProgramsPage(page);
    const name = unique('Test Program');
    await createProgramAndTrack(programs, name);
