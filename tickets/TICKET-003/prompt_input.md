...
- **Jira ticket:** TICKET-003
- **Surface area:** Web UI — Program creation form (admin console) + backing API
- **Role / permissions:** Admin user
- **Trigger:** Submitting the program creation form
- **Affected field:** Program `Name`
- **Related work:** TICKET-002 (Edit existing program details) — same validation rules likely apply on update
